...
column_names = ["edad", "sexo", 
                "escolaridad", "tiempoconsintomas", "idg-acr", "fiq-dolor", "fiq-fatiga", "fiq-calidad","autoreporte", "maltrato-fisico", "maltrato-psicologico","abusosexual", "clase" 
                ]

df = pd.read_csv("datasocio-cuadro-maltrato.csv", names=column_names)
print(df.shape)
df.head()


X = df.iloc[:,:12] #all rows all columns upto 12
print(X.head())
