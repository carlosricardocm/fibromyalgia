...
column_names = ["edad", "sexo", 
                "escolaridad", "tiempoconsintomas", "idg-acr", "fiq-dolor", "fiq-fatiga", "fiq-calidad","autoreporte", "clase" 
                ]

df = pd.read_csv("datasocio-cuadro.csv", names=column_names)
print(df.shape)
df.head()


X = df.iloc[:,:9] #all rows all columns upto 9
print(X.head())
